      ...
      {                                                         
        ...
        {                                                                
          ...
          { 
            ...
            client.print("<a href=\"/A\">Room ON</a><br>");
            client.print("<a href=\"/B\">Room OFF</a><br>");
        ...
        if (currentLine.endsWith("GET /A"))                    //ROOM on                                 // Check to see if the client request was "GET /A" or "GET /B" and so on...:
        {
          ledcAnalogWrite(LEDC_CHANNEL_0, 255);   
        }
        if (currentLine.endsWith("GET /B"))                    //Room off                                // Check to see if the client request was "GET /A" or "GET /B" and so on...:
        {
          ledcAnalogWrite(LEDC_CHANNEL_0, 0);   
        }
        if (currentLine.endsWith("GET /C"))                    //Door on
        {
          myservo.write(180);
          // ledcAnalogWrite(Led_channel_4, 255);
        }
        if (currentLine.endsWith("GET /D"))                    //Door off
        {
          myservo.write(90);
